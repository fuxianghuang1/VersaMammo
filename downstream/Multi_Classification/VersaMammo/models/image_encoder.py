...
def load_image_encoder(model_name):  
    if 'resnet' in model_name.lower():  
        ...
        if model_name == 'vitb14rand':
            ...
            _image_encoder,_image_encoder.out_dim = build_vit_model(arch='vit_base', pretrained=True, pretrained_path=f'{current_dir}/Sotas/VersaMammo/ViT/teacher_checkpoint_324999.pth')
