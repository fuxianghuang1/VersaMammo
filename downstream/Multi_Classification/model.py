...
class MultiTaskModel(nn.Module):
    ...
    def __init__(self, backbone_name, data_info, checkpoint_path=None,ours=None):
    ...
    def forward(self, x):
        ...
        outputs = {task: torch.sigmoid(classifier(features)) for task, classifier in self.classifiers.items()}
        return outputs