...
if __name__ == "__main__":
    ...
    input_path = f'{current_dir}/../data/{hypar["dataset"]}/Test'  # 替换为你的实际路径
    ...
    hypar["model"]=UNetEfficientNetB5(checkpoint_path=f'{current_dir}/../../Sotas/VersaMammo/ENb5/ENB5_SL.pth',pretrained=True)
    main(hypar=hypar)
